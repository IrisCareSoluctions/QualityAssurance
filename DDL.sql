CREATE TABLE TB_IC_TESTE (
    ...
    ind_funcional       NUMERIC NOT NULL,   -- 1 = Funcional; 2 - Não funcional
...
CREATE TABLE TB_IC_TESTE_LOG (
    ...
    resultado       VARCHAR2(50)  NOT NULL, -- REPENSAR EM DEIXAR COMO NÚMERICO
    obs_falha       VARCHAR2(150),
    acao_realizada  VARCHAR2(250)  NOT NULL -- AVALIAR SE A ACAO REALIZADA É A DESC_PROCECEDIMENTO DO TESTE
);
